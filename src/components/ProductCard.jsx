...
import { ShoppingCart, Play, ArrowUpRight } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
          ...
          <div className="flex gap-2">
            {product.tutoEtapes && (
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={(e) => { e.stopPropagation(); onTuto?.(product) }}
            ...
            <motion.button
              ...
              className="w-9 h-9 rounded-lg flex items-center justify-center text-black"
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-2xl"
